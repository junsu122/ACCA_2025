...
class Obstacle:
    ...
    def check_obstacle(self, size_type):
        ...
        if size_type == "small":
            ...
            line2_DA = [
                ...
                (34.1342, 36.5939),(32.1631, 37.017),
            ]  # DA = detection_area
            ...
            line1_DA = [
                ...
                (31.8343, 37.1265),(30.1985, 36.6519),
            ]
        if size_type == "big":
            line1_DA = [
                (-37.1543, -55.9792),
    ...
    def timer_callback(self):
        ...
        if (
            ...
            if (self.odometry.x - 12.7587) ** 2 + (
                self.odometry.y -  30.5507
            ) ** 2 < (self.odometry.x - 1240.6465275631675) ** 2 + (
                self.odometry.y - 2390.69487719818875
            ) ** 2:
                # k-city2 @ 작은거
